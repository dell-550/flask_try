...
prompt = Prompt
prompt.set_prompt(system_info="你是一个高级python开发工程师,帮助我解决编程上的问题", user_info="我在使用python时，遇到了这个问题{promble}，请你帮我解决并详细解答")
...
chain = prompt.set_prompt | model.get_model | output_parser.get_parser

chain.invoke(input = {'promble': "import 怎么使用"})